...
while True:
    text = input('Enter the text you would like to test the sentiment of: (q if quit) ').upper()
    
    if text == 'Q':
        break

    text_sentiment = predict_sentiment(text)
    print("This text has a sentiment of: " + text_sentiment)
